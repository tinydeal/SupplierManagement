...
<ul class="nav nav-pills nav-stacked">
	...
	<li id="supplier_category"><a href="index.php?mod=supplier_category">供应商分类管理</a></li>
	...
	<li id="order"><a href="index.php?mod=order">产品采购单管理</a></li>
	<li id="problem"><a href="index.php?mod=problem">合作问题记录管理</a></li>
	<li id="personnel_category"><a href="index.php?mod=personnel_category">人员分类管理</a></li>
